    ...
    <div>
        ...
        <div class="sign">
            <div class="sign__wrapper">
                <h6 class="sign__title">Silahkan isi email anda sebelum dapat lanjut ke tahap selanjutnya</h6>
                ...
                <div class="sign__input">
                    <div class="form-input">
                        <div class="form-input__wrapper">
                            <input v-model="userEmail" v-on:keyup="validationEmail" class="form-input__field" type="email" placeholder="Nama@mail.com" required :class="[ isError ? 'form-input__field--error' : ''  ]">
                            <span class="form-input__placeholder">Email</span>
                        </div>
                    </div>           
                </div>
                <button class="sign__button" :disabled="isDisable == true" type="button">Kirim</button>
            </div>
        </div>
    </div>
</template>
