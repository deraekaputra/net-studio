    ...
    <div>
        ...
        <div class="sign">
            <div class="sign__wrapper">
                <h6 class="sign__title">Masukan nomor seluler yang terdaftar.</h6>
                ...
                <div class="sign__input">
                    <div class="form-input">
                        <div class="form-input__wrapper">
                            <input class="form-input__field" type="text" placeholder="0812-XXXX-XXXX" :class="[ isError ? 'form-input__field--error' : ''  ]" @keypress="restrictChars">
                            <span class="form-input__placeholder">Nomor seluler</span>
                        </div>
                    </div>            
                </div>
                <button class="sign__button" type="button">Reset Password</button>
            </div>
        </div>
    </div>
</template>
