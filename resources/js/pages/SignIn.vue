    ...
    <div>
        ...
        <div class="sign">
            <div class="sign__wrapper">
                <h6 class="sign__title">Masuk untuk mendapatkan akses studio acara NET. favoritmu.</h6>
                ...
                <div class="sign__input">
                    <div class="form-input">
                        <div class="form-input__wrapper">
                            <input class="form-input__field" type="text" placeholder="0812-XXXX-XXXX atau Email" :class="[ isError ? 'form-input__field--error' : ''  ]" @keypress="restrictChars">
                            <span class="form-input__placeholder">Nomor seluler / Email</span>
                        </div>
                    </div>
                    <div class="form-input">
                        <div class="form-input__wrapper">
                            <input class="form-input__field" type="Password" placeholder="***********" :class="[ isError ? 'form-input__field--error' : ''  ]">
                            <span class="form-input__placeholder">Password</span>
                        </div>
                    </div>          
                    <span class="sign__link"><a href="/signup">Lupa Password ?</a></span>              
                </div>
                <button class="sign__button" type="button">Masuk</button>
                <span class="sign__link">Belum punya akun? <a href="/signup">Daftar</a></span>
            </div>
        </div>
    </div>
</template>
